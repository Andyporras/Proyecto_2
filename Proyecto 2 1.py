    ...
    def Mantenimiento():
        ...
        def transporte():
            ...
            def MostrarTransporte():
                ...
                datos=Listbox(ventanaDETransporte)
                datos.pack()
        ...
        def gestion_De_viaje():
            ...
            def EliminarViajes():
                ...
                etiqueta.place(x=10,y=10)
                entry=tkinter.Entry(ventanaViaje)
                entry.place(x=80,y=40)
                def eliminarViajes_aux():
                    ...
                    if((numero+"\n")in Viajes):
                        ...
                        mensaje=messagebox.showinfo("Error","El numero de viaje ingresad no exixte.")
                    #boton2=tkinter.Button(ventanaDETransporte,text="Eliminar")
            ...
            def ModificarViajes():
                ...
                etiqueta=tkinter.Label(ventanaViaje,text="Ingrese el numero del viaje a modificar")
                etiqueta.place(x=10,y=10)
                entry=tkinter.Entry(ventanaViaje)
                entry.place(x=70,y=30)
                ...
                boton=tkinter.Button(ventanaViaje,text="Modificar",command=ModificarViajes_aux)
                boton.place(x=100,y=50)    
            ...
            menuViaje.add_command(label="eliminar Viaje",command=EliminarViajes)
            menuViaje.add_command(label="modificar Viaje",command=ModificarViajes)
...
"""
            def buscar_empresa():
                ...
                etiqueta=tkinter.Label(ventana_consulta,"Ingrese la empresa a buscar: ")
                entry=tkinter.Entry(ventana_consulta)
                entry.pack()
                archivo=open("Gestion de viaje.txt")
                ...
                archivo.close()
                boton=tkinter.Button(ventana_consulta,text="Buscar",command=Buscar1)
                boton.pack()
                
                   

            menu_Consulta.add_command(label="Empresa",command=buscar_empresa)
...
def Modificar_Viajes_Aux(viajes, linea , cont):
    ...
    if(cont==13): 
        ...
        boton=tkinter.Button(ventModificar,text="Modificar",command=ProvinciaModificar)
        ...
        def modificarCiudad():
            ...
            boton.destroy()
            return Modificar_Viajes_Aux(viajes, linea+1, cont+1)
        boton=tkinter.Button(ventModificar,text="Modificar",command=modificarCiudad)
        boton.place(x=80,y=60)
    elif(cont==2):
        etiqueta=tkinter.Label(ventModificar,text="Ingrese la fecha de salida ")
        etiqueta.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        def modificarfecha():
            ...
            return Modificar_Viajes_Aux(viajes, linea +1, cont+1)
        boton=tkinter.Button(ventModificar,text="Modificar",command=modificarfecha)
        boton.place(x=80,y=60)
    elif(cont==3):
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la hora de salida.")
        etiqueta1.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        def modificarhora():
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarhora)
        boton1.place(x=80,y=60)
    elif(cont==4):       
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        etiqueta=tkinter.Label(ventModificar,text="Ingrese la provincia de llegada. ")
        etiqueta.place(x=10,y=10)
        def modificarLLegadaP():
            ...
            return Modificar_Viajes_Aux(viajes, linea +1, cont+1)
        boton=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaP)
        boton.place(x=80,y=60)
        
    elif(cont==5):
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la ciudad de llegada. ")
        etiqueta1.place(x=10,y=10)
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaC)
        boton1.place(x=80,y=60)
        
    elif(cont==6):
        etiqueta=tkinter.Label(ventModificar,text=" Ingrese la fecha de llegada. ")
        etiqueta.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        ...
        boton=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaF)
        boton.place(x=80,y=60)
        
    elif(cont==7):
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la hora de llegada")
        etiqueta1.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaH)
        boton1.place(x=80,y=60)
        
    elif(cont==8):
        archivo=open("Gestion de Transporte.txt")
        datos=archivo.read()
        etiqueta=tkinter.Label(ventModificar,text=f"datos")
        etiqueta.pack()
        etiqueta1=tkinter.Label(ventModificar,text=f"Ingrese el nombre de la empresa.")
        etiqueta1.pack()
        entry=tkinter.Entry(ventModificar)
        entry.pack()
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaE)
        boton1.pack()
    elif(cont==9):
        archivo=open("Gestion de Transporte.txt")
        datos=archivo.readlines()
        lista=Listbox(ventModificar)
        lista.pack()
        cont=0
        for lineas in datos:
            lista.insert(cont,f"linea {cont} : {lineas}")
            cont+=1
        etiqueta1=tkinter.Label(ventModificar,text=f"Ingrese el nombre del transporte.")
        etiqueta1.pack()
        entry=tkinter.Entry(ventModificar)
        entry.pack()
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarLLegadaT)
        boton1.pack()
    elif(cont==10):
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la el valor del voleto VIP")
        etiqueta1.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        def modificarVIP():
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarVIP)
        boton1.place(x=80,y=60)

    elif(cont==11):
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la el valor del voleto Normal")
        etiqueta1.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        def modificarNormal():
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarNormal)
        boton1.place(x=80,y=60)
    else:
        etiqueta1=tkinter.Label(ventModificar,text="Ingrese la el valor del voleto Economico")
        etiqueta1.place(x=10,y=10)
        entry=tkinter.Entry(ventModificar)
        entry.place(x=80,y=30)
        ...
        boton1=tkinter.Button(ventModificar,text="Modificar",command=modificarEconomico)
        boton1.place(x=80,y=60)
...
def buscar_por_filtro(lista,buscar,linea,Existe,linea2,):
    if linea > len(lista):
        if Existe:
            etiqueta=tkinter(ventana_consulta,f"Estos son los viajes encontrados según el dato que ingreso. ")
            etiqueta.pack()
            def salir5():
                aceptar=messagebox.askyesno("Salir", "¿Desea Salir?, Confirme...")
                if(aceptar):
                         ventana_consulta.destroy()
                         return menu()
            boton=tkinter.Button(ventana_consulta,text="salir",command=salir5)
            boton.pack()
        else:
            etiqueta=tkinter.Button(ventana_consulta,f"No se encontro nigún viajes que contenga el dato que ingreso, vuelva a intentarlo de nuevo.")
            etiqueta.pack()
            def salir4():
                aceptar=messagebox.askyesno("Salir", "¿Desea Salir?, Confirme...")
                if(aceptar):
                         ventana_consulta.destroy()
                         return menu()
            boton=tkinter.Button(ventana_consulta,text="salir",command=salir4)
            boton.pack()
    else:
        if buscar in lista[linea]:
            Mostrar_viaje(lista,linea -linea2, 0)
            return buscar_por_filtro(lista, buscar, linea + 15, True, linea2)
        else:
            return buscar_por_filtro(lista, buscar, linea + 15, Existe, linea2)
